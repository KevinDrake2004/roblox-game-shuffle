...
- Multipliers retuned for binomial land weights: design RTP ≈ 105% with `PlayerReturnFactor = 1.05`.
- Horizontal drag + smaller bounce noise so the ball does not fling to edge jackpots.
